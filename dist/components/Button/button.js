...
var Button = function (props) {
    var _a;
    var className = props.className, btnType = props.btnType, disabled = props.disabled, btnSize = props.btnSize, children = props.children, href = props.href, restProps = __rest(props
    // btn, btn-lg, btn-primary
    , ["className", "btnType", "disabled", "btnSize", "children", "href"]);
    // btn, btn-lg, btn-primary
